...
end_temporary_file_time = '2023073118'
time_span = 6
output_spatial_resolution = 1
temporary_file_path = r'D:\Articles\An optimized bias-correction framework for moisture source-receptor diagnose in Lagrangian models\YRB\temporary_output_DF'
final_output_path = r'D:\Articles\An optimized bias-correction framework for moisture source-receptor diagnose in Lagrangian models\YRB\final_output'
...
for n in range(0,len(files)):
    ...
    for i in range(0,len(raw)):
        ...
        print(files[n][-38:-28],"final step",i,'/',len(raw))
