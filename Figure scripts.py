...
fig.savefig( r'D:\Articles\WaterSip-DF\code-new\temporary\DF_RH_thresholds.tif', bbox_inches='tight' )
plt.close()
...
fig.savefig( r'D:\Articles\WaterSip-DF\code-new\temporary\DF_BLH_factors.tif', bbox_inches='tight' )
plt.close()

#%%
moisture_contribution_output_path = r'D:\Articles\WaterSip-DF\code-new\YRB\moisture_contribution_mm.nc'
moisture_contribution_mm = xr.open_dataset( moisture_contribution_output_path )['moisture_contribution_mm'].sum(dim='time')
...
fig.savefig( r'D:\Articles\WaterSip-DF\code-new\YRB\moisture_contribution_mm.tif', bbox_inches='tight' )
plt.close()
